...
namespace Kawa.Json
{
	...
	public static partial class Json5
	{
		...
		/// <returns>A JsonObj, list, string, int...</returns>
			...
			Func<object> number = () =>
			{
				...
				switch (bas)
				{
					case 10:
						...
						if (ch == '.')
						{
							//throw new JsonException("No floating point in this version!");
							if (str.Length == 0)
							{
								str.Append('0');
							}
				...
				if (bas == 16)
				{
					return Int64.Parse(str.ToString().Substring(2), System.Globalization.NumberStyles.HexNumber);
				}
				try
				{
		...
		/// <summary>
		/// Creates a string representation of a JsonObj, list, string, or int that conforms to the JSON or JSON5 standards.
		/// </summary>
